import { IData_SnippetNews, IData_SnippetDuplicates } from '@components/NewsCard';

export const newsResponseMock: IData_SnippetNews = {
    "ID": 260855433,
...
export const duplicatesResponseMock: IData_SnippetDuplicates = {
    'count': 3,
    'items': [newsResponseMock, newsResponseMock, newsResponseMock]
}
